...
> A simulation-based navigation framework designed to remain functional under sensor dropout and partial observability — implemented and benchmarked across a classical EKF pipeline and a learning-based SAC pipeline in ROS 2 + Gazebo.
